...
HEAD = vertex pixels lines mouse chain screen-triangles net-builder sha256 storage fader button mouse_app
SRCS = vertex pixels lines mouse chain screen-triangles net-builder sha256 storage fader button main
